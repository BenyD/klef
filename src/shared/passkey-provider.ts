...
// ones to their product names gives unnamed passkeys a real label ("iCloud
// Keychain") instead of a generic "Passkey". Curated from the community
// passkey-authenticator-aaguids registry; unknown IDs fall back to null.
...
const PROVIDERS: Record<string, string> = {
  ...
  "bbf4b6a7-679d-f6fc-c4f2-8ac0ddf9015a": "1Password",
